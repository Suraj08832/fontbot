...
NAME_STYLES = [
    ...
    "𓆰𝅃꯭᳚𓄂️𝆺𝅥⃝🔥 ⃪ͥ͢ ᷟ𓆩 {name} 乛|⁪⁬⁮⁮⁮⁮⁮ ‌⁪⁬𓆪🐼™",
    "ᯓ𓆰𝅃꯭᳚🦁{name}˶꯭꯭꯭꯭꯭꯭֟፝͟͝ ⚡꯭꯭꯭꯭꯭",
    "◄❥‌‌❥ ⃝⃪⃕🦚⟵᷽᷍{name}˚‌‌‌‌◡‌⃝🐬᪳ ‌⃪𔘓❁‌‌❍•:➛",
    "➺꯭ ꯭𝅥‌꯭𝆬‌🦋⃪꯭ ─⃛͢┼ 𝞄⃕𝖋𝖋 {name}🥵⃝⃝ᬽ꯭ ⃪꯭ ꯭𝅥‌꯭𝆬‌➺꯭⎯⎯᪵᪳",
    "ᯓ𓆰 𝅃{name}™ ٭ - 𓆪ꪾ⌯ 🜲 ˹ 𝐎ᴘ ˼",
    "—͟͞ 𝐈тᷟʑ꯭ͤ𓄂︪︫︠𓆩〭〬{name}⍣⃪͜ ꭗ̥̽𝆺꯭𝅥𔘓༌🪽⎯꯭̽⎯꯭ ꯭",
    "𓆰𓏲{name}𓂃ֶꪳ 𓆩〭〬🦋𓆪ꪾ",
    "𓆰⎯꯭꯭֯‌⌯ {name}𓂃ֶꪳ 𓆩〭〬🔥𓆪ꪾ",
    "🍹𝆺𝅥⃝🤍 ⃪ͥ͢ ᷟ●{name}🤍᪳𝆺꯭𝅥⎯꯭̽⎯꯭",
    "⋆⎯፝֟፝֟⎯᪵ 𝆺꯭𝅥{name} ᭄꯭🦋꯭᪳᪳᪻⎯̽⎯🐣",
    "⟶̽ꭙ⋆\"🔥𓆩〬 {name}⎯᳝֟፝֟⎯‌ꭙ⋆\"🔥",
    "⟶̽ꭙ⋆\"🔥𓆩〬 {name}🤍᪳𝆺꯭𝅥⎯᳝֟፝֟⎯‌",
    "⋆─፝─᪵།‌꯭{name} ا۬͢𝆺𝅥⃝🌸𝄄꯭꯭𝄄꯭꯭ ̶꯭𝅥ͦ𝆬👑",
    "❛ .𝁘ໍ{name}ꨄ 🦋𓂃•",
    "⟶̽𓆩〬𝁘ໍ{name}𓂃˖ॐ🪼⎯᳝֟፝⎯‌ꭙ⋆\"",
    "⏤͟͞ {name}𓂃 🔥𝆺𝅥 🜲 ⌯",
    "𓆰⎯꯭꯭֯‌{name}𓂃ֶꪳ 𓆩〭〬🔥𓆪ꪾ",
